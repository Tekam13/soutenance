...
const Forgot2 = ({ length = 4, onComplete }) => {
  ...
  return (
    <View style={styles.body}>
      ...
      <Text style={styles.img2}>Mot de passe oublié</Text>
        <View style={styles.dv2}>
          <Text style={styles.txt2}>veuillez entrer le code OTP envoyer pas SMS au numéro+237 67* *** **5 </Text>
        </View>
        ...
        <View style={styles.dv3}>
          <TouchableOpacity style={styles.bt} onPress={()=>navigation.navigate('Forgot3')}>
